...
import "../styles/NineSpecialsPage.css";
...
const sectionTitles = [
  "9 to 9 special tandori",
  "9 to 9 starters ",
  " 9 to 9 fast food combo",
  "9 to 9 special thali",
  "9 to 9 special chicken thali",
  // "Chinese",
  // "Chole Bhature",
  // "Dosa",
  // "Burgers",
            ...
            {teaMenu.map((dish, index) => (
              <div className="dish-card" key={index}>
                ...
                <div className="dish-info">
                  ...
                  <p className="dish-desc">Deliciously brewed {dish.name} </p>
                </div>
              </div>
            ))}
          </div>
...
export default NineToNineSpecials;
